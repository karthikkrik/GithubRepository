...
public class StockUpdateForm extends ActionForm {
	...
	/*public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		  ...
		  if (prodsubid==0 || prodsubid < 1) {
		      errors.add("prodsubname", new ActionMessage("product.err.id.required"));
		      // TODO: add 'error.name.required' key to your resources
		  } 
		  
		  else  if (prodsubname.equals(" ") || prodsubname.length() < 4) {
